...
class KeyboardViewController: UIInputViewController {
    ...
    */
    ...
    override func loadView() {
        ...
        let tellMe = UIScreen.mainScreen().bounds.size.height
        print(tellMe)
        self.bannerView = self.createBanner()
                ...
                for key in rowKeys {
                    if let keyView = self.layout?.viewForKey(key) {
                        ...
                        case Key.KeyType.KeyboardChange:
                            ...
                            keyView.addTarget(self, action: #selector(KeyboardViewController.advanceTapped), forControlEvents: .TouchUpInside)
	...
	class func getDeviceType()->TTDeviceType
	{
        ...
        case 1024:
            deviceType = TTDeviceType.TTDeviceTypeIPad
            break
