...
class LanguageSettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var settingsList: [(String, [String])] = [
        ...
        ("Extra Settings", [kSmallLowercase, kQuickSwitch]),
      //  ("Languages", ["English", "French", "Italian", "Lousianian Creole"])
    ]
    ...
    var settingsNotes: [String: String] {
        get {
            return [
                ...
                kQuickSwitch: "When turned on, keyboard automatically returns to the first page from the vowel page."
            ]
        }
    }
    ...
    func switchToKeyboardSelectionViewController(recognizer: UITapGestureRecognizer, langCode: String) {
        ...
        let vc = KeyboardSelectionViewController(keyboardDefinitions: ["QWERTY", "AZERTY", "QWERTZ", "WERTY"], langCode: langCode)
