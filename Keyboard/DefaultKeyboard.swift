...
func addNumericPage(defaultKeyboard: Keyboard)
{
    ...
    if NSUserDefaults.standardUserDefaults().boolForKey(kQuickSwitch) == true {
        AddCharacters(defaultKeyboard, characters: ["æ","á", "â", "ç", "é", "è", "ê", "í", "ì","î"], row: 1, page: 1)
        defaultKeyboard.addKey(Key.ModeChangeSpecialChars(), row: 2, page: 1)
        AddCharacters(defaultKeyboard, characters: ["ñ", "œ", "ò", "ô", "û"], row: 2, page: 1)
        
    } else {
        AddSpecialCharacters(defaultKeyboard, characters: ["æ","á", "â", "ç", "é", "è", "ê", "í", "ì","î"], row: 1, page: 1)
        defaultKeyboard.addKey(Key.ModeChangeSpecialChars(), row: 2, page: 1)
        AddSpecialCharacters(defaultKeyboard, characters: ["ñ", "œ", "ò", "ô", "û"], row: 2, page: 1)
    }
...
func addSymbolsPage(defaultKeyboard: Keyboard)
{
    ...
    AddSpecialCharacters(defaultKeyboard, characters: ["-", "/", ":", "(", ")", "$", "&", "@", "\""], row: 1, page: 2)
...
func FailSafeKeyboard() -> Keyboard {
    ...
    if NSUserDefaults.standardUserDefaults().boolForKey(kQuickSwitch) == true {
        AddCharacters(defaultKeyboard, characters: ["W", "E", "R", "T", "Y", "U", "I", "O", "P"], row: 0, page: 0)
        AddCharacters(defaultKeyboard, characters: ["A", "S", "D", "F", "G", "H", "J", "K", "L"], row: 1, page: 0)
        
    } else {
        
        AddSpecialCharacters(defaultKeyboard, characters: ["W", "E", "R", "T", "Y", "U", "I", "O", "P"], row: 0, page: 0)
        AddSpecialCharacters(defaultKeyboard, characters: ["A", "S", "D", "F", "G", "H", "J", "K", "L"], row: 1, page: 0)
        
    }
    
    defaultKeyboard.addKey(Key(.Shift), row: 2, page: 0)
    
    AddCharacters(defaultKeyboard, characters: ["Z", "C", "V", "B", "N", "M"], row: 2, page: 0)
