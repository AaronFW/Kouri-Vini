...
public class LanguageDefinition {
    ...
    class private func KVLanguageDefinition() -> LanguageDefinition {
        return LanguageDefinition(
            langCode: "LOU",
            englishName: "Louisianan Creole",
...
public class LanguageDefinitions {
    ...
    {
        definitions = [LanguageDefinition.KVLanguageDefinition()]
        langCodeToDefinition["LOU"] = definitions[0]
    }
